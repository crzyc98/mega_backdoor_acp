...
- Python 3.11+ (backend), TypeScript 5.7+ (frontend) + FastAPI 0.104+, React 19, Vite 6 (016-fix-export-filenames)
- N/A (bug fix, no storage changes) (016-fix-export-filenames)
...
## Recent Changes
- 016-fix-export-filenames: Added Python 3.11+ (backend), TypeScript 5.7+ (frontend) + FastAPI 0.104+, React 19, Vite 6
