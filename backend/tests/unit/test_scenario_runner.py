...
from app.services.scenario_runner import classify_status, run_single_scenario_v2
from app.services.models import ScenarioStatus, LimitingBound, ScenarioResult as ScenarioResultV2
...
class TestGridScenariosV2:
    ...
    def test_grid_v2_returns_grid_result(self, standard_participants):
        ...
        from app.services.models import GridResult
