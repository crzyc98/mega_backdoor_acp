...
from app.routers.schemas import (
    ...
    GridAnalysisResult,
    GridSummary,
    # V2 schemas (decimal format only)
    ScenarioRequestV2,
    ScenarioResultV2,
    GridRequestV2,
    GridResultV2,
...
from app.services.scenario_runner import run_single_scenario, run_grid_scenarios, run_single_scenario_v2, run_grid_scenarios_v2
from app.services.models import ScenarioStatus
from app.storage.database import get_db
from app.storage.models import AnalysisResult as AnalysisResultModel
from app.storage.models import GridAnalysis as GridAnalysisModel
...
from app.services.employee_impact import EmployeeImpactService

router = APIRouter()
limiter = Limiter(key_func=get_remote_address)


# V1 endpoints removed - use V2 endpoints (/v2/scenario, /v2/grid) with decimal rates (0.0-1.0)
...
async def run_scenario_v2(
    ...
    return ScenarioResultV2(
        ...
        limit_125=result.limit_125,
        limit_2pct_uncapped=result.limit_2pct_uncapped,
        cap_2x=result.cap_2x,
        limit_2pct_capped=result.limit_2pct_capped,
...
async def run_grid_v2(
    ...
    for scenario in result.scenarios:
        ...
        api_scenarios.append(ScenarioResultV2(
            ...
            limit_125=scenario.limit_125,
            limit_2pct_uncapped=scenario.limit_2pct_uncapped,
            cap_2x=scenario.cap_2x,
            limit_2pct_capped=scenario.limit_2pct_capped,
            effective_limit=scenario.effective_limit,
            max_allowed_acp=scenario.max_allowed_acp,
            margin=scenario.margin,
            binding_rule=scenario.binding_rule,
